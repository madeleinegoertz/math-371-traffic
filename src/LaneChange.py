...
'''
    ...
    ("Minimizing Overall Brakings Induced by Lane-changes"), see <a             
        ...
        D. Helbing, Realistische Mikrosimulation von Strassenverkehr mit einem       
...
class LaneChange():
    ...
    def change_ok(self, me, f_old, b_old,
                    f_new, b_new):
        '''
        ...
        :return: bool
            change or not
        '''
        #assert isinstance(me, Car) and isinstance(f_new, Car)
